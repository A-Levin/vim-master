...
from app.bot.handlers.start import help_handler, profile_handler, start_handler
...
class TestStartHandler:
    ...
    async def test_start_handler_success(self, test_message, make_message):
        ...
        message = make_message(
            text="/start", user_id=12345, username="testuser", first_name="John"
        )
    ...
    async def test_profile_handler(self, make_message):
        ...
        message = make_message(
            text="/profile", user_id=12345, username="testuser", first_name="John"
        )
        message.answer = AsyncMock()
...
class TestMenuHandlers:
    ...
    async def test_profile_menu_handler(self, make_message):
        ...
        message = make_message(text="👤 Профиль", first_name="Alice", username="alice")
        message.answer = AsyncMock()
